 ...
 */
function statisticscalc_civicrm_caseTypes(&$caseTypes) {
  _statisticscalc_civix_civicrm_caseTypes($caseTypes);
}
 ...
 */
function statisticscalc_civicrm_angularModules(&$angularModules) {
  _statisticscalc_civix_civicrm_angularModules($angularModules);
}
